        ...
        <div class="card">
            <div class="card-body">
             ...
             <form method="POST" action="{{route('update.permission')}}" class="forms-sample">
                    @csrf
                                  <div class="mb-3">
                                    <input type="hidden" name="id" class="form-control" value={{ $permissions->id }}  id="id" autocomplete="off" >

                                      <label for="exampleInputUsername1" class="form-label">Name</label>
                                      <input type="text" name="name" class="form-control" value={{ $permissions->name }} id="name" autocomplete="off">
                                      @error('name')
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <select name="group_name" value={{ $permissions->group_name }} class="form-select">
